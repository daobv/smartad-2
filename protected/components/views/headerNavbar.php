<div class="header navbar" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="<?php echo Yii::app()->getBaseUrl(true); ?>"><img src="<?php echo Setting::getSetting("logo") ?>">
            </a>
        </div>
                ...
                <?php foreach ($categories as $category): ?>
                    ...
                    <li class="dropdown">
                        <a href="<?php echo $category->slug; ?>"
                           <?php if (count($subCategories) > 0): ?>class="dropdown-toggle"
                           data-toggle="dropdown" <?php endif; ?>>
                        ...
                        <?php if (count($subCategories) > 0): ?>
                            <ul class="dropdown-menu">
                                <?php foreach ($subCategories as $subCategory): ?>
                                    <li>
                                        <a href="<?php echo Yii::app()->createUrl('chuyen-muc/' . $subCategory->slug); ?>"><?php echo $subCategory->name ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        <?php endif; ?>
                ...
                <?php if (!Yii::app()->user->isGuest): ?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo Yii::app()->createUrl('user/account-info') ?>">Thông Tin Tài Khoản</a></li>
                            <li><a href="<?php echo Yii::app()->createUrl('user/payment-info') ?>">Thông Tin Thanh Toán</a></li>
                            <li><a href="<?php echo Yii::app()->createUrl('user/logout') ?>">Thoát</a></li>
                        </ul>
                    </li>
                <?php else:; ?>
                    <li class="dropdown login">
                        <button class="dropdown-toggle btn btn-primary" data-toggle="dropdown">Đăng nhập <b
                    ...
                    <li>
                        <button type="button"
                                onclick="window.location='<?php echo Yii::app()->createUrl("user/register") ?>';"
                                class="btn btn-lg btn-default">Đăng ký
                        </button>
                    </li>
                <?php endif; ?>
            </ul>
